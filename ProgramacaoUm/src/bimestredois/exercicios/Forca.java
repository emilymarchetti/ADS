...
public class Forca {
    ...
    public static void main (String[]args) throws Exception {
        ...
        LineNumberReader leitorLinha = new LineNumberReader(new FileReader("D:/Forca.txt"));
        ...
        BufferedReader leitorArquivo = new BufferedReader(new FileReader("D:/Forca.txt"));
